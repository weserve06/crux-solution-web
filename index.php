			...
			<div class="flips__container col-md-12">
			   ...
			   <div class="flip-card">
			      <div class="flip-card__inner">
			         <div class="flip-card__front">
			            <div class="flip-card__icon" style="width:40px;">
			                  <img src="Svg/ui.svg" width="100%">
			            </div>
			            <span class="flip-card__title">UI / UX <br>Design</span>
			            <div class="flip-card__box flip-card__box--right">
			               <div class="flip-card__number">04</div>
			               <div class="flip-card__image">
			               	    <img class="stiker2" src="Svg/stiker2.svg" width="100%">
			               </div>
			            </div>
			         </div>
			         <div class="flip-card__back">
			            <div class="flip-card__back-top">
			               <div class="flip-card__icon flip-card__icon--colored">
			                  <img src="Svg/ui.svg" style="width:50px;">
			               </div>
			               <h3 class="flip-card__title">UI / UX <br>Design</h3>
			            </div>
			            <div class="flip-card__box flip-card__box--left">
			               <div class="flip-card__number">04</div>
			               <div class="flip-card__image flip-card__image--back">
			            ...
			            <div class="flip-card__description">Eye-catching and user-friendly design is key to conversion. Our qualified UI/UX experts will bring your idea from concept to full-fledged responsive design with engaging elements created specially for your target audience.</div>
			         </div>
			      </div>
			   </div>
			   <div class="flip-card">
			      <div class="flip-card__inner">
			         ...
			         <div class="flip-card__back">
			            <div class="flip-card__back-top">
			               ...
			               <h3 class="flip-card__title">DevOps <br>Services</h3>
			            </div>
			            <div class="flip-card__box flip-card__box--left">
			               <div class="flip-card__number">05</div>
			               <div class="flip-card__image flip-card__image--back">
	...
	<div id="progress-bar-container">
		<ul>
			<li class="step step01 active">
				...
				<div class="step-inner font-mont">HOME WORK</div>
			</li>
			<li class="step step02">
				<span>3 day</span>
				<div class="step-inner font-mont">RESPONSIVE PART</div></li>
			<li class="step step03">
				<span>5 day</span>
				<div class="step-inner font-mont">Creative cREATIONS</div></li>
			<li class="step step04">
				<span>7 day</span>
				<div class="step-inner font-mont">TESTIMONIALS PART</div></li>
			<li class="step step05">
				<!-- <span>hello world4</span> -->
				<div class="step-inner font-mont">OUR LOCATIONS</div></li>
		</ul>
...
<section class="Aboutsoftware">
	<div class="container">
		<div class="row">
	        ...
	        <div class="row">
	        	<div class="col-lg-6">
	        		<img src="images/19963.jpg" width="100%">
	        	</div>
...
<div class="container-fluid">
	<div class="row conntecteddiv">
		<div class="col-lg-12">
			<div class="row d-flex justify-content-center">
			<div class="col-sm-6 col-md-6 col-lg-6 d-flex justify-content-center align-items-center">
				<p class="font-mont1" style="padding-top: 15px;">GET CONNECTED WITH US ON</p>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-6 d-flex justify-content-center align-items-center">
                <div class="icons">
		...
		<div class="row">
			<div class="col-md-6 col-lg-3 outerfooter1">
				<div class="innerfooter">
					<h4 class="font-mont1 footer-line">CRUX <br/>Solutions</h4>
					<p class="font-nunito1"><i class="fa fa-phone" aria-hidden="true" style="padding-right: 5px;"></i>&nbsp;+123456789</p>
					<p class="font-nunito1"><i class="fa fa-envelope" aria-hidden="true" style="padding-right: 8px;"></i>ritika27@gmail.com</p>
			    </div>
			</div>
			<div class="col-md-6 col-lg-3 outerfooter">
				<div class="innerfooter footerproducts">
					<h4 class="font-mont1 footer-line">PRODUCTS</h4>
					<p class="font-nunito1">DONATION</p>
					<p class="font-nunito1">REQUEST</p>
              		<p class="font-nunito1">USERINFO</p>
					<p class="font-nunito1">SEEING</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3 outerfooter">
				<div class="innerfooter">
					<h4 class="font-mont1 footer-line">USEFUL LINKS</h4>
					<p class="font-nunito1">YOUR ACCOUNT</p>
                    <p class="font-nunito1">BECOME AN AFFILIATE</p>
					<p class="font-nunito1">SHIPPING RATES</p>
					<p class="font-nunito1">HELP</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3 outerfooter">
				<div class="innerfooter">
					<div class="innerfooter">
						<h4 class="font-mont1 footer-line">CONTACT</h4>
						<iframe class="shadow" width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=ctm%20+(i%20Love%20you)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
 				</div>
				</div>
			</div>
		</div>
...
<div class="endingpolicies">
	<div class="font-mont1">© copyright Design By Ritika</div><div class="font-mont1">Terms | Policies</div></div>
</body>
<script>
